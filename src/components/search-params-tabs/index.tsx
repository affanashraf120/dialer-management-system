...
function convertReadonlyURLSearchParamsToURLSearchParams(
  readonlyParams: ReadonlyURLSearchParams
): URLSearchParams {
  // Create a new URLSearchParams instance from the entries of the readonlyParams
  return new URLSearchParams(Array.from(readonlyParams.entries()));
}
  ...
  const hrefFor: Context["hrefFor"] = React.useCallback(
    (value) => {
      const params = new URLSearchParams(
        convertReadonlyURLSearchParamsToURLSearchParams(searchParams)
      );
